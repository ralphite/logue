...
- V2-DOC-05 — INTEGRATED — Action Replace/Copy/Keep 使用统一 AI Source / Document revision adoption 合同；Keep 成功后保留 Candidate，并以原 adoption ID 提供即时 Undo；Replace Undo 的终态 revision Conflict 清除失效入口并恢复 Action，网络失败保留同一 adoption 供重试。
