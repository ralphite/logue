...
export const DocumentsEmpty: Story = { args: { route: "?view=generate&tab=documents", fixture: "empty" } };
export const DocumentsLoading: Story = { args: { route: "?view=generate&tab=documents", fixture: "loading" } };
export const DocumentsServiceError: Story = { args: { route: "?view=generate&tab=documents", fixture: "error" } };
export const SkillsEmpty: Story = { args: { route: "?view=generate&tab=skills", fixture: "empty" } };
