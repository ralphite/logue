...
function fixtureResponse(input: RequestInfo | URL, mode: Exclude<StoryFixtureMode, "loading">) {
  ...
  switch (url.pathname) {
    case "/v1/status": return response({ ok: true, api_version: 1, provider_configured: true, generation_ready: true, voice_ready: true, overall_ready: true, provider_needs_attention: false, provider_errors: { generation: null, voice: null }, model: "gemini-3.6-flash", storage_root: "Storybook fixture", storage_bytes: 1_048_576, version: "story" });
