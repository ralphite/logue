...
function fixtureResponse(input: RequestInfo | URL, mode: Exclude<StoryFixtureMode, "loading">) {
  ...
  switch (url.pathname) {
    case "/v1/status": return response({ ok: true, api_version: 1, ai_configured: true, model: "gemini-3.6-flash", storage_root: "Storybook fixture", storage_bytes: 1_048_576, version: "story" });
