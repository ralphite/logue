      ...
      <TooltipPrimitive.Portal>
        <TooltipPrimitive.Content
          ...
          className={cn(
            ...
            "text-[15px] font-medium leading-4 text-white shadow-[0_7px_22px_rgba(24,25,22,0.22)]",
            "data-[state=delayed-open]:animate-[tooltip-in_120ms_ease-out] motion-reduce:animate-none",
          )}
        >
          <span>{content}</span>
          {shortcut && <kbd className="text-[14px] font-normal text-white/55">{shortcut}</kbd>}
        </TooltipPrimitive.Content>
      </TooltipPrimitive.Portal>
    </TooltipPrimitive.Root>
  );
