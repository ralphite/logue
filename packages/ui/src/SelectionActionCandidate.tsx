...
export function SelectionActionCandidate({ skillName, text, primaryAction, anchor, busyAction, error, project, documents = [], keepUndoAvailable = false, documentUndoAvailable = false, documentUndoAction = "replace", documentUndoRetryable = false, onTextChange, onPrimary, onCopy, onKeep, onUndoKeep, onSaveDocument, onUndoDocument, onCancel }: {
  skillName: string;
  text: string;
