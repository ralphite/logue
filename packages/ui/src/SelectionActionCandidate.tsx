...
export function SelectionActionCandidate({ skillName, text, primaryAction, anchor, busyAction, error, project, documents = [], documentUndoAvailable = false, onTextChange, onPrimary, onCopy, onKeep, onSaveDocument, onUndoDocument, onCancel }: {
  skillName: string;
  text: string;
