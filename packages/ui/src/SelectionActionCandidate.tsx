...
export function SelectionActionCandidate({ skillName, text, primaryAction, anchor, busyAction, error, project, documents = [], keepUndoAvailable = false, documentUndoAvailable = false, onTextChange, onPrimary, onCopy, onKeep, onUndoKeep, onSaveDocument, onUndoDocument, onCancel }: {
  skillName: string;
  text: string;
